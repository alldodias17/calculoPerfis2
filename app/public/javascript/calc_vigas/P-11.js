...
id('txtMomento').value = (AUX_M3).toFixed(2);
var txtMomento = parseFloat(id('txtMomento').value);
if(AUX_M5 > AUX_M3){
    id('txtMomento').value = (AUX_M5).toFixed(2);
}
...
id('txtIx').value = (AUXPESO * AUXCOMPT**5 - 12.8 * AuxCargP * AuxComp2 * (AUXCOMPT**3 / 8 - (AUXCOMPT**2 - AuxComp2**2) * AUXCOMPT / 2)) / (8064 * AUXCOMPT**2);
...
id('xtAreaFC').value = Aux_Fc1 / (2 * AUXCOMPT) / AuxTenes / b;
