window.onload = function () {
  ...
  var TAB_AB = ["1","1.5","2","3","4","6","8","10"];
  var TAB_N1 = ["0.14","0.196", "0.229", "0.263", "0.281", "0.299", "0.307","0.313"];
  var TAB_N2 = ["0.24","0.231", "0.246", "0.267", "0.282", "0.299", "0.307", "0.313"];    //'0.208
  var TAB_AB_ant = ["1","1.5","2","3","4","6","8","10"];
...
do{
    Cont = Cont + 1;
    if (AUX0 = TAB_AB_ant[Cont]){
      N1 = TAB_N1[Cont];
      N2 = TAB_N2[Cont];
    }   
    if (AUX0 > TAB_AB_ant[Cont]){}  if (AUX0 < TAB_AB[Cont]){
      N1 = (TAB_N1[Cont] - TAB_N1[Cont]) / (TAB_AB[Cont] - TAB_AB[Cont]) * (AUX0 - TAB_AB[Cont]) + TAB_N1[Cont];
      N2 = (TAB_N2[Cont] - TAB_N2[Cont]) / (TAB_AB[Cont] - TAB_AB[Cont]) * (AUX0 - TAB_AB[Cont]) + TAB_N2[Cont];
...
//Exit Do
//End If
//If AUX0 > TAB_AB(CONT_ANT) And AUX0 < TAB_AB(Cont) Then
//N1 = (TAB_N1(Cont) - TAB_N1(CONT_ANT)) / (TAB_AB(Cont) - TAB_AB(CONT_ANT)) * (AUX0 - TAB_AB(CONT_ANT)) + TAB_N1(CONT_ANT)
//N2 = (TAB_N2(Cont) - TAB_N2(CONT_ANT)) / (TAB_AB(Cont) - TAB_AB(CONT_ANT)) * (AUX0 - TAB_AB(CONT_ANT)) + TAB_N2(CONT_ANT)
//Exit Do
//End If
//CONT_ANT = Cont
//Loop
