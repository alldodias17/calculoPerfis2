...
form12.ixx.value = 4 * ESPES * (h * Math.pow(A2,3) + B2 * Math.pow(A2 / 2 + RN,2) + 2 * U * Math.pow(A2 / 2 + e * RN,2) + 2 * c * Math.pow(RN,3) + p * Math.pow(C2,3) + C2 / 4 * Math.pow(A2 - C2,2)) + 2 * Math.pow(FITA1,3) * ESPES / 12;
...
form12.j.value = 2 * Math.pow(AB * 2 * (BB + 1.5 * ESPES) - 4 * CB * ESPES - 2 * FITA1 * ESPES,2) * ESPES / FITA;
