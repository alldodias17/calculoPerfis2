...
id('area_total').value = 2 * ESPES * (FITA + FITA1);
...
id('ixx').value = (4 * ESPES * (h * Math.pow(A2,3) + B2 * Math.pow(A2 / 2 + RN,2) + 2 * U * Math.pow(A2 / 2 + e * RN,2) + 2 * c * Math.pow(RN,3) + p * Math.pow(C2,3) + C2 / 4 * Math.pow(A2 - C2,2)) + 2 * Math.pow(FITA1,3) * ESPES / 12).toFixed(2);
var IX = id('ixx').value;
...
id('wt').value =  2 * ESPES * (AB * 2 * (BB + i * ESPES) - 4 * CB * ESPES - 2 * FITA1 * ESPES);
var WT = id('wt').value;
...
id('j').value = (2 * Math.pow(AB * 2 * (BB + 1.5 * ESPES) - 4 * CB * ESPES - 2 * FITA1 * ESPES,2) * ESPES / FITA).toFixed(2);
