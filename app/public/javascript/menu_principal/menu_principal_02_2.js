...
var x6 = Math.pow(parseInt(form09.dtam_a.value), 3);
var x7 = Math.pow(parseInt(form09.dtam_a.value) / 2 + parseInt(form08.raio_neutro.value), 2);
var x8 = Math.pow(parseInt(form09.dtam_a.value) / 2 + x3 * form08.raio_neutro.value,2);
var x9 = Math.pow(parseInt(form08.raio_neutro.value), 3);
var x10 = Math.pow(parseInt(form10.dtam_c.value), 3);
var x11 = Math.pow(parseInt(form09.dtam_a.value) - parseInt(form10.dtam_c.value), 2);
...
form10.largura_da.value = 2 * parseInt(form10.dtam_c.value) + 2 * parseInt(form09.dtam_b.value) + parseInt(form09.dtam_a.value) + 4 * parseFloat(form10.ud.value);
//AREA1 = FITA * ESPES
...
form04.dtam_m.value = (parseInt(form06.dtam_bbarra.value) * parseInt(ESPES) / (12 * parseInt(form12.ixx.value)) * (6 * parseInt(form07.dtam_D.value) * Math.pow(form05.dtam_a1.value,2) + 3 * parseInt(form06.dtam_bbarra.value) * Math.pow(parseInt(form05.dtam_a1.value),2) - 8 * Math.pow(parseInt(form07.dtam_D.value),3))).toFixed(2);
//x0 = -(XB + EME)
...
form16.ip.value = (form12.ixx.value)*1 + (form13.iyy.value)*1 + (form19.area_total.value)*1 *ip02*1;
...
form12.j.value = Math.pow(ESPES,3) / 3 * form10.largura_da.value;
