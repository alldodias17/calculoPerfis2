...
id('largura_da').value = 5 * U + D2 + C2 + 2 * B2 + A2 + E2;
...
id('dtam_xx').value = (D2 * ESPES * (BB + RN + D2 / 2) + U * ESPES * (BB + RN - 0.637 * RN) + ESPES * (C2 + E2) * BB + 2 * U * ESPES * (BB - RN + 0.637 * RN) + 2 * B2 * ESPES * BB / 2 + 2 * U * ESPES * (RN - 0.637 * RN)) / AREA01;
...
id('ixx').value = 5 * 0.149 * RN * ESPES + D2 * ESPES**3 / 12 + ESPES * C2**3 / 12 + B2 * ESPES**3 / 6 + ESPES * A2**3 / 12 + ESPES * E2**3 / 12 + D2 * ESPES * (YB - CB)**2 + U * ESPES * (YB - CB + RN - 0.637 * RN)**2 + C2 * ESPES * (YB - CB / 2)**2 + 2 * U * ESPES * (YB - RN + 0.637 * RN)**2 + B2 * ESPES * YB**2 + A2 * ESPES * (AB / 2 - YB)**2 + 2 * U * ESPES * (AB - RN + 0.637 * RN - YB)**2 + B2 * ESPES * (AB - YB)**2 + E2 * ESPES * (AB - YB - E2 / 2 - RN)**2;
...
id('iyy').value = 5 * b * RN * ESPES + ESPES * Math.pow(D2,3) / 12 + C2 * Math.pow(ESPES,3) / 12 + ESPES * Math.pow(B2,3) / 6 + A2 * Math.pow(ESPES,3) / 12 + E2 * Math.pow(ESPES,3) / 12 + D2 * ESPES * Math.pow(BB + RN + D2 / 2 - XB,2) + U * ESPES * Math.pow(BB + RN - 0.637 * RN - XB,2) + C2 * ESPES * Math.pow(BB - XB,2) + 2 * U * ESPES * Math.pow(BB - RN + 0.637 * RN - XB,2) + 2 * B2 * ESPES * (BB / 2 - XB) * (BB / 2 - XB) + 2 * U * ESPES * Math.pow(XB - RN + 0.637 * RN,2) + A2 * ESPES * Math.pow(XB,2) + E2 * ESPES * Math.pow(BB - XB,2);
...
id('wy').value = IY / (BB + ESPES / 2 + DB - CGX);
...
//iv1 = (IV / AREA1) ^ 0.5
id('iv').value = ((IV / AREA01)**0.5).toFixed(2) || 0.00;;
var iv1 = parseFloat(id('iv').value);

//iz1 = (iz / AREA1) ^ 0.5
id('iz').value = (iz / AREA01)**0.5;
